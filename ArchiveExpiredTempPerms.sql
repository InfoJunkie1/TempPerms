...
* Procedure Test: 
	...
	EXEC sys.sp_recompile @objname = N'perm.PermissionsToDelete_archive_expired';
...
BEGIN
	...
	BEGIN TRY
		...
		INSERT INTO perm.PermissionsToDelete_Archive(PermDeleteID,
													ServerName,
													DatabaseName,
													UserName,
													PermissionType,
		...
		DELETE	FROM perm.PermissionsToDelete
		WHERE IsActive = 0
